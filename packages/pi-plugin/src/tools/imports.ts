 ...
 * Supports TS, JS, TSX, Python, Rust, Go, Solidity, Java, C#, PHP, Kotlin, Scala, Swift, Ruby, Lua.
 */
...
export function registerImportTools(pi: ExtensionAPI, ctx: PluginContext): void {
  pi.registerTool({
    ...
    label: "import",
    description:
      "Language-aware import management. Supports TS, JS, TSX, Python, Rust, Go, Solidity, Java, C#, PHP, Kotlin, Scala, Swift, Ruby, Lua. Ops: `add`, `remove`, `organize`. Use aft_safety checkpoint/undo before broad cleanup.",
